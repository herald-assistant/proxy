...
public class MeContextDtos {
    ...
    public record MeContext(
            ...
            @Schema(description = "User profile preferences stored by the proxy.", example = "{\"explainUserDescription\":\"junior analyst\",\"notifyNewTemplates\":true}")
    ...
    public record UserProfilePrefs(
            ...
            @Schema(description = "Free-form description of the user, used to tailor explanations and help content.", example = "junior analyst, prefers short explanations")
            String explainUserDescription,

            @Schema(description = "Whether the user wants to receive notifications about newly published templates.", example = "true")
            boolean notifyNewTemplates,

            @Schema(description = "Last update timestamp (ISO-8601). Null when never updated.", example = "2026-01-04T16:12:33Z")
            String updatedAt
    ) {}
    ...
    public record UpdateUserProfilePrefs(
            ...
            @Schema(description = "Free-form description of the user, used to tailor explanations and help content.", example = "beginner business analyst")
            @Size(max = 1200)
            String explainUserDescription,

            @Schema(description = "Whether the user wants to receive notifications about newly published templates.", example = "false")
            boolean notifyNewTemplates
    ) {}
}
